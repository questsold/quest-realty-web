...
const HERO_IMAGE = "file:///Users/aliberry/.gemini/antigravity/brain/99e654a7-e829-4f6c-9918-6f66f098480f/luxury_modern_home_hero_1772224466209.png";
...
export function Hero() {
    ...
    return (
        <section className="relative min-h-[800px] md:h-[90vh] flex items-center justify-center overflow-hidden">
            ...
            <div className="container relative z-10 px-6 mx-auto">
                ...
                >
                    ...
                    <motion.div
                        variants={itemVariants}
                        className="relative w-full max-w-2xl transition-all duration-500 hover:scale-[1.02]"
                    >
                            ...
                            <form onSubmit={handleSearch} className="flex items-center">
                                <div className="flex-grow flex items-center pl-6">
                                    ...
                                    <input
                                        ...
                                        className="w-full py-4 md:py-5 bg-transparent focus:outline-none text-slate-900 text-sm md:text-base font-bold placeholder:text-slate-400"
                                        value={searchQuery}
                                ...
                                <button
                                    type="submit"
                                    className="bg-slate-900 hover:bg-primary text-white px-10 py-4 md:py-5 rounded-[2rem] font-black text-xs md:text-sm uppercase tracking-widest transition-all shadow-xl shadow-slate-900/20 active:scale-95 flex items-center gap-2"
                                >
                        ...
                        {/* Staggered Suggestions Dropdown */}
                        <AnimatePresence>
                                                ...
                                                <div className="flex items-center gap-4">
                                                    ...
                                                    <div className="flex flex-col">
                                                        ...
                                                        <span className="text-[9px] font-extrabold uppercase tracking-widest text-slate-400">
                                                            {item.type === 'address' ? `Address in ${item.OriginalCity}` : 'City / Region'}
                                                        </span>
                                                    </div>
                                                </div>
            ...
            <div className="absolute bottom-0 left-0 right-0 h-48 bg-gradient-to-t from-background via-background/40 to-transparent z-[5]" />
        </section>
    );
}
